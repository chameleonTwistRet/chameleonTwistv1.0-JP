...
/* 0x00 */ Vec3f position; //position
/* 0x0C */ s32 unkC;
/* 0x10 */ s32 unk10; // total move time
/* 0x14 */ s32 unk14;
/* 0x18 */ s32 unk18; // come back hold
/* 0x1C */ s32 unk1C; // go to next hold
/* 0x20 */ s32 unk20; // be here by when in the object's moving timer (generally equal total move time + all previous steps)
...
/* 0x48 */ s32 unk48;
/* 0x4C */ s32 unk4C;
/* 0x50 */ s32 id; //id in levelData pointers
/* 0x54 */ s32 unk54;
/* 0x58 */ s32 unk58;
/* 0x5C */ s32 unk5C;
...
/* 0x00 */ Collectable* levelDataCollectable;
/* 0x04 */ s32 unk_04;
/* 0x08 */ s32 unk_08;
/* 0x0C */ s32 bitfield;
/* 0x10 */ s32 actorIndex;
...
/* 0x08 */ Collectable* collectables; //pointer of levelData collectables, 0 for none
/* 0x0C */ SpriteActor* spriteActors; //pointer of levelData spriteActors, 0 for none
/* 0x10 */ s32 rmObjCount; //how much to iterate in Collision.objects
/* 0x14 */ s32 rmActCount; //how much to iterate in Collision.actors
/* 0x18 */ s32 clctCount; //how much to iterate in Collision.collectables
...
/* 0x94 */ s32 cameraMode;
/* 0x98 */ Vec3f cameraAnchor; //the position the camera is anchored within the room
/* 0xA4 */ f32 unkA4;
/* 0xA8 */ f32 unkA8;
/* 0xAC */ f32 unkAC;
...
/* 0x000 */ u32 unk0; //used to ID selected chameleon.
/* 0x004 */ u32 unk4;
/* 0x008 */ u32 unk8;
/* 0x00C */ PlayerActor_s actorInit;
/* 0x13C */ Tongue tongueInit;
/* 0x748 */ u8 cameraInit[0x6C]; //camera substruct(s?) yet defined. copied like the other 2
/* 0x7B4 */ s32 unk7b4;
/* 0x7B8 */ s32 unk7b8;
/* 0x7BC */ u32 zone;
...
/* 0x00 */ Gfx* Graphics;
/* 0x04 */ ModelCollision* Collisions;
/* 0x08 */ char pad[0x28];
} StageModel;
...
typedef struct Door {
/* 0x00 */ s32 index;
/* 0x04 */ s32 unk4; //not read?
/* 0x08 */ s32 inZone;
/* 0x0C */ Rect3D rect;
/* 0x24 */ Vec3f max;
/* 0x30 */ u32 direction; // index in gCardinalDirections
/* 0x34 */ s32 unk34; //not read?
/* 0x38 */ s32 unk38;
/* 0x3C */ s32 unk3C;
/* 0x40 */ s32 toZone;
/* 0x44 */ s32 unk44;
...
/* 0x0C */ SpriteActor* sprites;
/* 0x10 */ s32 unk10;
/* 0x14 */ s32 unk14;
/* 0x18 */ s32 amountOfSpriteActors; //needs verification
/* 0x1C */ s32 unk1C;
/* 0x20 */ s32 unk20;
/* 0x24 */ s32 unk24;
/* 0x28 */ f32 cameraRot; //basically how top-down you want the room to be. mostly for extRooms
/* 0x2C */ s32 unk2C;
/* 0x30 */ f32 unk30;
/* 0x34 */ f32 unk34;
/* 0x38 */ f32 unk38;
...
/* 0x00 */ s32 width; // width in rooms of map
/* 0x04 */ s32 height; // height in rooms of map
/* 0x08 */ RoomInstance* roomInstances;
/* 0x0C */ s32 (*roomsMap)[];
} StageMapData;
...
/* 0x00 */ StageMapData* roomsMap;
/* 0x04 */ RoomInstance* roomInstances;
/* 0x08 */ StageModel* models;
/* 0x0C */ u16 modelCount;
/* 0x0E */ u16 unkC;
...
/* 0x04 */ void* romAddrStart;
/* 0x08 */ void* romAddrEnd;
/* 0x0C */ void* ramAddrStart;
/* 0x10 */ void* ramAddrEnd;
} segTableEntry;
...
/* 0x04 */ s32 unk_04;
/* 0x08 */ s32 unk_08;
/* 0x0C */ s32 useCase; // CutsceneUses enum
/* 0x10 */ cutsceneCamera* unk_10;
/* 0x14 */ s32 flag1;
/* 0x18 */ cutsceneCamera* unk_18;
/* 0x1C */ Vec3f toPlacePos;
/* 0x28 */ Gfx* toPlace; //segment pointer
/* 0x2C */ s32 flag2;
/* 0x30 */ s32 unk_30;
/* 0x34 */ s32 unk_34;
/* 0x38 */ f32 unk_38;
...
/* 0x54 */ s32 unk_54;
/* 0x58 */ s32 unk_58;
/* 0x5C */ s32 useCaseTwo; // CutsceneUses enum
/* 0x60 */ cutsceneCamera* unk_60;
/* 0x64 */ s32 flag1Two;
/* 0x68 */ cutsceneCamera* unk_68;
/* 0x6C */ Vec3f toPlacePosTwo;
/* 0x78 */ Gfx* toPlaceTwo; //segment pointer
/* 0x7C */ s32 flag2Two;
/* 0x80 */ s32 unk_80;
/* 0x84 */ s32 unk_84;
/* 0x88 */ f32 unk_88;
