...
enum actorIDs {
	...
	CANNONBALL,
	BL_BOSS_SEGMENT,
	EXPLOSION, // immune to stopwatch powerup
	BL_BOSS_BOMBS,
#ifdef VER_JP
...
// these also function as general modes?
// most notably for the battle types and chameleon model switching
enum BattleTypes {
    BATTLE_TYPE_NOTBATTLE = 0,
