...
FieldObject* func_800CB294(Vec3f, f32);
...
void func_8006BD58(f32, f32, f32, f32, s32);
...
void SetPlayerEyeExpression(s32, s32, s32);
...
char* parseIntToHex(u32, s32, char*);
void SetProcessType(s32);
void func_8008FDF8(void);
Vec3f* func_800C08B8(Vec3f*, PlayerActor*, Door*);
