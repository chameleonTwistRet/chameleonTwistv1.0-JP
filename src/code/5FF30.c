...
void func_8008E7B8(CTTask_CompatFix* arg0) {
    setPrimColor(arg0->unk5F, arg0->unk61, arg0->unk_63, arg0->unk67);
...
void func_800919D8(s32 arg0, s32 arg1) {
    ...
    if ((arg0 >= 0) || (arg1 != 0)) {
        ...
        task->function = func_800917A8; //ignore warning
        task->unk_62 = 128;
        task->unk_5C = arg0;
        task->unk_64 = arg1;
    }
...
void func_8009D954(s32 notUsed) {
    func_800610B8();
    SetTextGradient(0x46U, 0xC0U, 0xEBU, 0xFFU, 0U, 0x8FU, 0x24U, 0xFFU, 0x46U, 0xC0U, 0xEBU, 0xFFU, 0U, 0x8FU, 0x24U, 0xFFU);
...
void func_8009DDEC(CTTask* task) {
    func_8008D6E4(task, &gContMain[task->unk_62]);
}
...
void Task_GameOverLetter(CTTask* task) {
    ...
    SetTextGradient(240, 20, 10, 255, 220, 120, 1, 255, 240, 20, 10, 255, 220, 120, 1, 255);
