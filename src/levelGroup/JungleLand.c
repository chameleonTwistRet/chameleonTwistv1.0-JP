...
unsigned char JungleLand_pointers_Bin[] = {
#include "build/include/assets/levelGroup/JungleLand/pointers.inc.c"
};
...
unsigned char JungleLand_map_Bin[] = {
#include "build/include/assets/levelGroup/JungleLand/map.inc.c"
};
